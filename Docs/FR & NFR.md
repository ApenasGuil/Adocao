...
O sistema deve solicitar confirmação, via e-mail, antes de excluir a conta.
Os pets, que ainda estiverem disponíveis e vinculados a conta excluída, devem ser deletados.

#### RF-03.2: Remoção de dados
O sistema deve remover todos os dados do usuário após a confirmação da exclusão.
